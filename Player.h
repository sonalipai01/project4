...
class Player {
 public:
     ...
     *           If num_ships is already eqaul to MAX_NUM_SHIPS,
     ...
     * Effects:  If the pos is not yet hit for the opponent, and the opponent
     ...
     *
     *           If pos is already hit for the opponent, the move is a miss 
     *
